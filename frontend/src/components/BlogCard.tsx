...
export function Circle() {
  return <div className="h-1 w-1 mt-1 rounded-full bg-slate-500"></div>;
}
...
export function Avatar({
  ...
  return (
    <div
      className={`relative inline-flex items-center justify-center overflow-hidden bg-slate-500 rounded-full ${
